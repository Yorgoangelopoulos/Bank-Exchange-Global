...
A futuristic, modern banking dashboard built with Next.js, TypeScript, and Tailwind CSS. Manage your banks and credit cards with a sleek, cyberpunk-inspired interface.

![Dashboard Screenshot](https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-lLfPneAKEAAh7sFNnln5x71sDZA4iV.png)

## ✨ Features

### 🏛️ **Bank Management**
- **Add New Banks**: Complete bank information with IBAN, card details, and passwords
- **View Bank Details**: Comprehensive bank information with copyable fields
- **Edit Banks**: Modify existing bank information
- **Delete Banks**: Remove banks with confirmation dialog
- **Search Banks**: Real-time search across bank names, details, and IBANs

### 💳 **Credit Card Management**
- **Multiple Credit Cards**: Manage Visa, Mastercard, and American Express cards
- **Card Details**: View complete card information including limits and balances
- **Copy to Clipboard**: One-click copy for all card details
- **Edit & Delete**: Full CRUD operations for credit cards

### 🎨 **Modern UI/UX**
- **Futuristic Design**: Cyberpunk-inspired dark theme with neon accents
- **Particle Effects**: Animated background particles for immersive experience
- **Responsive Layout**: Works perfectly on desktop, tablet, and mobile
- **Real-time Updates**: Live time display with Istanbul timezone
- **System Uptime**: Track application uptime with localStorage persistence

### 🔒 **Security Features**
- **Password Protection**: Hidden passwords with toggle visibility
- **Secure Storage**: All data stored locally with encryption-ready structure
...
\`\`\`bash
git clone https://github.com/your-username/bankapp-exchange-global.git
cd bankapp-exchange-global
\`\`\`
...
├── bank-data.json         # Sample bank data
...
### Dashboard Views
- **🏠 Dashboard**: Main bank overview with search functionality
- **➕ New Bank**: Add new bank with form validation
- **💳 Credit Cards**: Manage credit cards with detailed views
- **⚙️ Settings**: Bank management with edit/delete operations

### Data Management
- **LocalStorage**: Persistent data storage
- **Real-time Search**: Instant filtering across all data
- **Form Validation**: IBAN and date validation
...
NEXT_PUBLIC_APP_NAME=BankApp Exchange Global
\`\`\`

### Customization
- **Colors**: Modify `tailwind.config.js` for custom color schemes
- **Icons**: Replace Lucide icons in component files
- **Data**: Update `bank-data.json` for different sample data

## 📊 Performance

- **Optimized Rendering**: React.memo and useCallback for performance
- **Lazy Loading**: Dynamic imports for better loading times
- **Efficient State**: Minimal re-renders with proper state management
- **LocalStorage**: Fast data persistence without external dependencies
...
*Transform your banking experience with BankApp Exchange Global* 🚀
\`\`\`

```typescriptreact file="dashboard.tsx"
[v0-no-op-code-block-prefix]"use client"

import type React from "react"

import { useEffect, useState, useRef } from "react"
import { Activity, Command, HardDrive, Hexagon, TypeIcon as type, LucideIcon, RefreshCw, Search, Settings, Shield, Wifi, Database, Globe, Cpu, Lock, Zap, Terminal, Plus, ArrowLeft, Eye, EyeOff, CreditCard, Trash2, AlertTriangle, Edit2, Save, Copy, Check, X, CreditCardIcon as CardIcon, Calendar, Hash, Key, User } from 'lucide-react'
                    ...
                    <div className="p-4 border-t border-slate-700/50">
                      <div className="space-y-3">
                        <Button
                          ...
                          onClick={() => {
                            // TODO: Implement edit functionality for credit cards
                            console.log("Edit credit card:", selectedCreditCard.id)
                            // For now, we'll show an alert
                            alert(`Edit functionality for ${selectedCreditCard.cardName} will be implemented soon!`)
                          }}
                        >
                          <Edit2 className="mr-2 h-4 w-4" />
                          Edit Card
                        ...
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button
                              variant="outline"
                              className="w-full border-red-900/50 bg-red-900/20 hover:bg-red-900/30 text-red-400 hover:text-red-300"
                            >
                              <Trash2 className="mr-2 h-4 w-4" />
                              Delete Card
                            </Button>
                          ...
                          <AlertDialogContent className="bg-slate-900 border-slate-700">
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription className="text-slate-400">
                                Are you sure you want to delete{" "}
                                <span className="font-semibold text-slate-300">{selectedCreditCard.cardName}</span>? This
                                action cannot be undone and all card data will be permanently removed.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                              <AlertDialogCancel className="bg-slate-800 border-slate-700 text-slate-300 hover:bg-slate-700">
